---
title: "QA Flow Node Reference: All Test Automation Node Types"
sidebarTitle: "Node Types"
description: "Complete reference for all QA Flow node types organized by category: triggers, actions, assertions, control flow, and lifecycle hooks."
---
...
<Accordion title="assertAttribute — DOM Attribute Check">
...
<Accordion title="assertClass — CSS Class Check">
