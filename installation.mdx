---
title: "Installing QA Flow: npx, Docker, and Local Dev Setup"
  ...
  <Tab title="Local Dev">
    ...
    <Steps>
      ...
      <Step title="Set up the database">
        ...
        The default `server/.env` configures a local SQLite database at `./dev.db` (relative to the `server/` directory). Edit the file to point at a Turso cloud database if preferred.
      </Step>
